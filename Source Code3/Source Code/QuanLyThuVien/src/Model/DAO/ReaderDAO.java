...
//		pstm.setBoolean(1, true);
	...
	public int deleteReaderBook(String book_id) throws ClassNotFoundException, SQLException {
         ...
         * @throws SQLException 
         */
        public int deleteReaderBooks(String[] bookIdList) throws ClassNotFoundException, SQLException {
		int result = 0;
		if (conn == null)
			conn = ConnectDatabase.getMySQLConnection();
		String sql = "Delete From Reader where book_id IN (" + String.join(",", bookIdList) + ")";
		PreparedStatement pstm = (PreparedStatement) conn.prepareStatement(sql);
		result = pstm.executeUpdate();
		return result;
	}
